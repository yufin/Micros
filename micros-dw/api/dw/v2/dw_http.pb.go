...
type DwServiceHTTPClient interface {
	GetEnterpriseCredential(ctx context.Context, req *GetEntInfoReq, opts ...http.CallOption) (rsp *EntCredentialResp, err error)
...
func (c *DwServiceHTTPClientImpl) GetEnterpriseCredential(ctx context.Context, in *GetEntInfoReq, opts ...http.CallOption) (*EntCredentialResp, error) {
	var out EntCredentialResp
...
func (c *DwServiceHTTPClientImpl) GetEnterpriseInfo(ctx context.Context, in *GetEntInfoReq, opts ...http.CallOption) (*EntInfoResp, error) {
	var out EntInfoResp
