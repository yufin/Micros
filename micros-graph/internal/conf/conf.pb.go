...
type Data struct {
	...
	NebulaDb *Data_NebulaDb `protobuf:"bytes,4,opt,name=nebulaDb,proto3" json:"nebulaDb,omitempty"`
}
...
func (x *Data) GetNebulaDb() *Data_NebulaDb {
	if x != nil {
		return x.NebulaDb
	}
	return nil
...
type Data_NebulaDb struct {
	...
	UseHttp2 string `protobuf:"bytes,5,opt,name=use_http2,json=useHttp2,proto3" json:"use_http2,omitempty"`
}

func (x *Data_NebulaDb) Reset() {
	*x = Data_NebulaDb{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_NebulaDb) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_NebulaDb) ProtoMessage() {}

func (x *Data_NebulaDb) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_NebulaDb.ProtoReflect.Descriptor instead.
func (*Data_NebulaDb) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 3}
}

func (x *Data_NebulaDb) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Data_NebulaDb) GetPort() int64 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *Data_NebulaDb) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *Data_NebulaDb) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *Data_NebulaDb) GetUseHttp2() string {
	if x != nil {
		return x.UseHttp2
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xe6, 0x04, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x52, 0x07, 0x6d, 0x6f, 0x6e, 0x67, 0x6f, 0x44, 0x62, 0x12, 0x35, 0x0a, 0x08, 0x6e, 0x65, 0x62,
	0x75, 0x6c, 0x61, 0x44, 0x62, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x4e, 0x65,
	0x62, 0x75, 0x6c, 0x61, 0x44, 0x62, 0x52, 0x08, 0x6e, 0x65, 0x62, 0x75, 0x6c, 0x61, 0x44, 0x62,
	...
	0x75, 0x74, 0x1a, 0x1b, 0x0a, 0x07, 0x4d, 0x6f, 0x6e, 0x67, 0x6f, 0x44, 0x62, 0x12, 0x10, 0x0a,
	0x03, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x69, 0x1a,
	0x7f, 0x0a, 0x08, 0x4e, 0x65, 0x62, 0x75, 0x6c, 0x61, 0x44, 0x62, 0x12, 0x12, 0x0a, 0x04, 0x61,
	...
	0x6f, 0x72, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x5f, 0x68, 0x74, 0x74, 0x70, 0x32,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x48, 0x74, 0x74, 0x70, 0x32,
	0x42, 0x23, 0x5a, 0x21, 0x62, 0x72, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x6b, 0x6d, 0x69, 0x63, 0x72,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_NebulaDb)(nil),       // 8: kratos.api.Data.NebulaDb
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.nebulaDb:type_name -> kratos.api.Data.NebulaDb
